...
void	redraw_window(t_main *s)
{
	...
	mlx_string_put(s->mlx, s->mlx_window, 620, (220 + (60 + (30 * 3))), 0xF9DB24, "        - Use right and left arrows to turn.");
	mlx_string_put(s->mlx, s->mlx_window, 620, (220 + (60 + (30 * 5))), 0xF9DB24, "        - Use the H key to enable mouse rotation.");
